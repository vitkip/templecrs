...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .title-about { font-size: 11pt; margin-top: 8px; text-align: left; width: 100%; }
    .title-about p { margin-top: 6px; width: 100%; }
    .about-bullet-dash { width: 1.1em; }
...
<table class="org-row">
    <tr>
        ...
        <td class="org-right" style="padding-top: 45pt;">
            ...
            <div class="ref-line">ນະຄອນຫຼວງວຽງຈັນ, ວັນທີ {{ $currentDay }} {{ $currentMonth }} {{ $currentYear }}</div>
        </td>
    </tr>
</table>
...
<div class="title-about">
    <p>ອີງຕາມ ພາລະບົດບາດ, ສິດ ແລະ ໜ້າທີ່ ຂອງ ຄະນະກໍາມະການຮັບຜິດຊອບການເງິນ-ການບັນຊີ ຂອງກັມມາ ທິການສາທາລະນູ<br>ປະການ 
        ສູນກາງອົງການພຸດທະສາສະໜາສຳພັນແຫ່ງ ສປປ ລາວ;
    ຄະນະກໍາມະການຮັບຜິດຊອບການເງິນ-ການບັນຊີ ຂໍນ້ອມນະ<br>ມັດສະການສະເໜີລາຍງານສະຫຼຸບສັງລວມ ກ່ຽວກັບການຄຸ້ມຄອງ ແລະ ຈັດຕັ້ງປະຕິບັດແຜນງົບປະມານ
    ໃນຄັ້ງ: ວັນທີ {{ $fromDay }} {{ $fromMonth }} {{ $fromYear }} ຫາ ວັນທີ {{ $toDay }} {{ $toMonth }} {{ $toYear }} ເພື່ອຊີ້ແຈງສະພາບຄ່ອງທາງດ້ານການເງິນ ແລະ ຍອດເຫຼືອຄັງຕົວຈິງ 
     </p>
